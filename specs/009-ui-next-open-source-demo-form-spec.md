...
- 备注字段第一阶段不强制追加项目信息，最小化沿用固定意向说明即可
...
- 提交成功后，后端已向 CRM 发起 Lead 写入，且 `sjly=community`
