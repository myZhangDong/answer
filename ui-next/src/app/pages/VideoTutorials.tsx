    ...
    <div className="flex flex-col gap-6 pb-12 md:gap-8">
      <div className="flex-1 min-w-0 flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-8">
          {/* Video Grid */}
          <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-y-10">
          {loading && (
            ...
            <Link to={`/video/${video.id}`} key={video.id} className="group flex flex-col gap-4 cursor-pointer">
              ...
              <div className="relative aspect-video rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-800 ring-1 ring-slate-200/50 dark:ring-slate-700/50 shadow-sm transition-all duration-300 group-hover:-translate-y-1 group-hover:shadow-md group-hover:ring-[#009EFF]/30 dark:group-hover:ring-[#33B1FF]/30">
                ...
                <div className="absolute inset-0 bg-slate-900/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white/40 text-white ring-1 ring-white/30 shadow-lg backdrop-blur-md transition-transform duration-300 scale-90 group-hover:scale-100 sm:h-14 sm:w-14">
                    <Play className="ml-0.5 h-5 w-5 fill-white sm:ml-1 sm:h-6 sm:w-6" />
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-x-3.5 gap-y-2 text-[12px] font-medium text-slate-500 dark:text-slate-400">
